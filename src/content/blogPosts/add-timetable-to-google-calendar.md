...
image:
  {
    src: "https://images.unsplash.com/photo-1616530834117-9167fb0d8ebc?&fit=crop&w=430&h=240",
    alt: "Copying your timetable to Google Calendar",
  }
...
However, if you're like me and prefer to use Google Calendar, you might be wondering how you can copy your timetable to Google Calendar as well. A few years ago, there used to be a tool called "Timetable to Google Calendar" that allowed you to do just that. Ever since the migration to Microsoft 365, this tool has been disabled, [despite still being accessible](https://csprd.mcmaster.ca/psp/prcsprd/EMPLOYEE/EPM/c/MCM_CUSTOM_MENU.MCM_TIMETBL_CMP.GBL). Luckily for everyone, we've revived the tool ourselves, and made it available for you to use!
...
![Log into Google button](https://i.imgur.com/K7g4SWS.jpeg)
